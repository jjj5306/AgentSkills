Create a single horizontal sprite strip for the Codex app digital pet `beolle` in the state `failed`.
...
- Show failure through slumped pose, drooping top antennae, closed or sad eyes, and a slightly lower body position. Do not add limbs or underside appendages.
